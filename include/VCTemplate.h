...
#ifndef VCTEMPLATE_H_
#define VCTEMPLATE_H_
...
/**
 *  The VCTemplate class.
 */
class VCTemplate : public PoolObjectSQL
{
public:
    ...
    /**
     *  Returns a copy of the VirtualClusterTemplate
     *    @return A copy of the VirtualClusterTemplate
     */
...
private:
    ...
    friend class VCTemplatePool;

    // -------------------------------------------------------------------------
    // VCTemplate Attributes
    // -------------------------------------------------------------------------
    ...
    {
        ostringstream oss(VCTemplate::db_bootstrap);
...
protected:
    ...
    VCTemplate(int id,
               ...
               int umask,
               VirtualClusterTemplate * _template_contents);
