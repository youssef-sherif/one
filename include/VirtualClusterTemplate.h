...
#ifndef VIRTUAL_CLUSTER_TEMPLATE_H_
#define VIRTUAL_CLUSTER_TEMPLATE_H_
...
/**
 *  Virtual Cluster Template class, it represents a VC configuration file.
 */
class VirtualClusterTemplate : public Template
{
public:
    VirtualClusterTemplate():Template(false,'=',"TEMPLATE"){};
    ...
    VirtualClusterTemplate(VirtualClusterTemplate& vct):Template(vct){};
...
#endif /*VIRTUAL_CLUSTER_TEMPLATE_H_*/
