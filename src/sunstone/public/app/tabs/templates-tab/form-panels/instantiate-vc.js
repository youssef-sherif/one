...
define(function(require) {
    ...
    var TemplateHTML = require("hbs!./instantiate-vc/html");
    var TemplateRowHTML = require("hbs!./instantiate-vc/templateRow");
    ...
    var CapacityInputs = require("tabs/templates-tab/form-panels/create/wizard-tabs/general/capacity-inputs-vc");
    ...
    var FORM_PANEL_ID = require("./instantiate-vc/formPanelId");
    ...
    function FormPanel() {
      ...
      this.actions = {
        "instantiateVC": {
          "title": Locale.tr("Instantiate VC From VM Template"),
          "buttonText": Locale.tr("Instantiate VC"),
          "resetButton": false
        }
      };
