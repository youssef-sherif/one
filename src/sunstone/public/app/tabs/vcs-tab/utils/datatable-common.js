...
define(function(require) {
  ...
  function _elementArray(element_json) {
    ...
    if (element.STATE == OpenNebulaVC.STATES.ACTIVE) {
      state = OpenNebulaVC.shortLcmStateStr(element.LCM_STATE);
    } else {
      state = OpenNebulaVC.stateStr(element.STATE);
    }
