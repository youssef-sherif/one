...
define(function(require) {
  ...
  var StateActions = require('tabs/vcs-tab/utils/state-actions');
  ...
  function _html() {
    var resizeStateEnabled = StateActions.enabledStateAction("VC.resize",
  ...
  function _setup(context) {
    var that = this;
    if (Config.isTabActionEnabled("vcs-tab", "VC.resize")) {
