...
define(function(require) {
  ...
  function _html() {
    ...
    var stateStr = OpenNebula.VC.stateStr(this.element.STATE);
    var lcmStateStr = OpenNebula.VC.lcmStateStr(this.element.LCM_STATE);
    var hostnameHTML = OpenNebula.VC.hostnameStrLink(this.element);
    var vrouterHTML = "--";

    var IP = OpenNebula.VC.ipsStr(this.element);
