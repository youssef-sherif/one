...
define(function(require) {
  ...
  var TEMPLATE_TAB_ID = require('tabs/vc-templates-tab/tabId');
  var WIZARD_TABS = [
    require('tabs/vc-templates-tab/form-panels/create/wizard-tabs/os'),
    require('tabs/vc-templates-tab/form-panels/create/wizard-tabs/io'),
    require('tabs/vc-templates-tab/form-panels/create/wizard-tabs/context'),
    require('tabs/vc-templates-tab/form-panels/create/wizard-tabs/other')
  ]
  ...
  function FormPanel() {
    ...
    this.actions = {
      'updateconf': {
        'title': Locale.tr("Update VC Configuration"),
  ...
  function _submitWizard(context) {
    ...
    Sunstone.runAction("VC.updateconf", this.resourceId, TemplateUtils.templateToString(templateJSON));
    return false;
  ...
  function _submitAdvanced(context) {
    ...
    Sunstone.runAction("VC.updateconf", this.resourceId, template);
    return false;
  }
