    ...
    $('#' + DIALOG_ID + 'Form', context).submit(function() {
      ...
      OpenNebula.C.save_as_template({
        ...
        success: function(request, response){
          OpenNebula.Action.clear_cache("VCTEMPLATE");
          Notifier.notifyMessage(Locale.tr("VC Template") + ' ' + template_name + ' ' + Locale.tr("saved successfully"))
        },
