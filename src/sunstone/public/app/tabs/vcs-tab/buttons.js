...
define(function(require) {
  ...
  if(confirm){
    ...
    "VC.recover" : {
      ...
      tip: Locale.tr("Recovers a stuck VC that is waiting for a driver operation. \
                    The recovery may be done by failing, succeeding or retrying the current operation. \
                    YOU NEED TO MANUALLY CHECK THE VC STATUS ON THE HOST, to decide if the operation \
                    was successful or not, or if it can be retried.\
                    <br/>\
                    <br/>Delete: This will delete the selected VCs\
                    <br/>Delete-recreate: This will delete and recreate VCs to PENDING state"),
      custom_classes : "state-dependent"
    },
    "VC.startvnc" : {
      type: "action",
