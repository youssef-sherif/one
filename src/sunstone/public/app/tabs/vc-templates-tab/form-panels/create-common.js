...
define(function(require) {
  ...
  var VC_TEMPLATES_TAB_ID = require('tabs/vc-templates-tab/tabId');
  ...
  function FormPanel() {
    ...
    var create_title = Locale.tr("Create VC Template");
    var update_title = Locale.tr("Update VC Template");
    ...
    $.each(WIZARD_TABS, function(index, wizardTab) {
      try {
        wizardTabInstance = new wizardTab({listener: that, tabId: VC_TEMPLATES_TAB_ID});
