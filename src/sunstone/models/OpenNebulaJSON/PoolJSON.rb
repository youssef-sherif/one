...
module OpenNebulaJSON
    ...
    class VirtualClusterPoolJSON < OpenNebula::VirtualClusterPool; include JSONUtils; end
    ...
    class VCTemplatePoolJSON < OpenNebula::VCTemplatePool; include JSONUtils; end
